...
#bucket_name = os.environ['secom-daas-bucket']
#dynamo_table = os.environ['daas-table']
...
table = resource.Table("daas-table")
...
def read_file(s3_key):
    ...
    obj = s3.get_object(Bucket="secom-daas-bucket", Key=s3_key)
...
def handler(event, context):
    # TODO implement
    my_bucket = s3.Bucket("secom-daas-bucket")
    ...
    for object_summary in my_bucket.objects.filter(Prefix="processed/processed"):
